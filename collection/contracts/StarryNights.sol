...
contract StarryNights is ERC721Enumerable, Ownable {
    // for computing {tokenURI}.
    ...
    // takes in the baseURI to set _baseTokenURI & initializes an instance of whitelist interface
    constructor(
        string memory baseURI,
        address whitelistContract
    ) ERC721("Starry Nights", "STN") {
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        require(msg.value >= _price, "Plese send 0.001ETH");
        tokenIds += 1;
        ...
        emit PreMinted(msg.sender, tokenIds);
    }

    // To mint 1 NFT per transaction after the presale has ended.
    ...
    // only called when msg.data is not empty
